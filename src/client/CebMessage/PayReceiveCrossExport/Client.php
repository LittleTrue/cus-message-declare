    ...
    public function generateXmlPost($declareConfig, $declareParams)
    {
        ...
        foreach ($declareParams as $key => $value) {
            ...
            $ReceiptsEle = [
                ...
                'ceb:ebpCode' => empty($value['EBPEntNo']) ? '' : $value['EBPEntNo'],
                'ceb:ebpName' => empty($value['EBPEntName']) ? '' : $value['EBPEntName'],
                'ceb:ebcCode' => $value['EBEntNo'],
                'ceb:ebcName' => $value['EBEntName'],
